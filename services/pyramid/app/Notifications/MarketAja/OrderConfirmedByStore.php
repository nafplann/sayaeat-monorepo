...
class OrderConfirmedByStore extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function __construct(StoreOrder $order)
    {
        ...
        $this->subject = "Hai admin, pesanan diterima toko ($storeName)!";
    ...
    {
        $orderUrl = url("/manage/market-aja");
