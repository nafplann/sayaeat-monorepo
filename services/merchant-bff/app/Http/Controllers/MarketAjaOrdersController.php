...
class MarketAjaOrdersController extends Controller
{
    ...
    {
        return view('market-aja.settings');
    }
    ...
    public function details(string $orderId): View
    {
        try {
            ...
            return view('market-aja.details', compact('order'));
        } catch (\Exception $e) {
            abort(404);
        }
    }
    ...
    public function process(string $orderId): View
    {
        try {
            $order = $this->orderService->getById($orderId);
            return view('market-aja.process', compact('order'));
        } catch (\Exception $e) {
            abort(404);
        }
    }
    ...
    public function update(Request $request, string $orderId): RedirectResponse
    {
        try {
            ...
            return redirect()->route('market-aja.index')
