const OwnerMakanAjaOrders = {
    index() {
        ...
        function getActiveOrders() {
            Utils.ajax(Utils.baseUrl('manage/orders/list?statusCategory=activeForMerchant'), 'GET', 'application/json', {}, {
        ...
        function getCompletedOrders() {
            Utils.ajax(Utils.baseUrl('manage/orders/list?statusCategory=completed'), 'GET', 'application/json', {}, {
                success: function (response) {
        ...
        $(document).on('click', '.order-rejected', function (e) {
            ...
            Swal({
                ...
                preConfirm: (reason) => {
                    ...
                    Utils.ajax(Utils.baseUrl(`manage/orders/reject/${id}?reason=${reason}`), 'POST', 'application/json', {}, {
                        success: function (response) {
                            if (response.status) {
        ...
        $(document).on('click', '.order-accepted', function (e) {
            ...
            Swal({
                ...
                preConfirm: () => {
                    ...
                    Utils.ajax(Utils.baseUrl(`manage/orders/process/${id}?action=order-accepted`), 'POST', 'application/json', {}, {
                        success: function (response) {
                            if (response.status) {
                                Utils.notify('', response.message);
                                setTimeout(() => {
        ...
        $(document).on('click', '.order-ready', function (e) {
            ...
            Swal({
                ...
                preConfirm: () => {
                    ...
                    Utils.ajax(Utils.baseUrl(`manage/orders/process/${id}?action=order-ready`), 'POST', 'application/json', {}, {
                        success: function (response) {
                            if (response.status) {
                                Utils.notify('', response.message);
                                setTimeout(() => {
...
export default OwnerMakanAjaOrders;
