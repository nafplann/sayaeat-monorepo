        ...
        <form
            ...
            <div class="tab-container">
                <ul class="nav nav-tabs nav-fill" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#home-2" role="tab">{{ __('app.store_profile') }}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#profile-2" role="tab">{{ __('app.operating_hours') }}</a>
                    </li>
                </ul>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group required">
                                    ...
                                    <small class="form-text text-muted">
                                        {{ env('HAPI_URL') . '/store/' }}<span id="slug-sample">{{ $isEditing ? $data->slug : '' }}</span>
                                    </small>
                                </div>
                                <div class="form-group required">
                                    <label>{{ __('app.store_name') }}</label>
                                ...
                                <div class="form-group required">
                                    ...
                                    <select class="select form-control" name="category">
                                        @foreach(\App\Enums\StoreCategory::cases() as $category)
                                            <option
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <button class="btn-primary btn-block" type="button" id="show-my-location">{{ __('app.use_current_location') }}
                                    </button>
                                ...
                                @if (!auth()->user()->isOwner())
                                    <div class="form-group ">
                                        <label>{{ __('app.owner') }}</label>
                                        <select class="select form-control" name="owner_id">
                                            <option disabled selected>{{ __('app.select_owner') }}</option>
