...
class OrderIsOnDelivery extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function __construct(StoreOrder $order)
    {
        ...
        $this->subject = "Hai $customerName, pesanan kamu sedang diantar";
        $this->body = 'Mohon ditunggu yaa.';
    }
